export const useDashboardData = () => {
  ...
  const getExchangeBindings = async () => {
    return [
      { id: 1, name: 'Binance', status: 'connected', lastSynced: '2026-07-18T10:30:00Z', balance: 8450.75 },
      { id: 2, name: 'OKX', status: 'connected', lastSynced: '2026-07-18T10:30:00Z', balance: 4000.00 },
      { id: 3, name: 'Bybit', status: 'disconnected', lastSynced: '2026-07-01T08:00:00Z', balance: 0.00 }
    ]
  }
