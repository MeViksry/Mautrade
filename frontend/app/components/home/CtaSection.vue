    ...
    <div class="container reveal">
      ...
      <div class="section-head">
        <h2 class="section-head__title">
          Request<br><em>early access</em>.
        </h2>
        <p class="section-head__sub">
          Mautrade is onboarding in closed cohorts — 220 active accounts today, growing in batches of 25 roughly every three weeks. Submit the form and we'll send a full walkthrough of the Layer and Gas Fee mechanics immediately, then follow up within 72 hours if the next cohort fits your case.
        </p>
      </div>
        ...
        >
          <div class="form-row">
            <div class="form-field">
              ...
              <input
                ...
                type="text"
                name="name"
                placeholder="As it appears on your exchange account"
                required
              >
            </div>
            <div class="form-field">
          ...
          <div class="form-field">
            ...
            <div class="form-radios">
              <label
                class="form-radio"
                :class="{ selected: selectedVolume === 'lt100k' }"
                @click="selectRadio('lt100k')"
              >
                <input
                  type="radio"
                  name="volume"
                  value="lt100k"
                  :checked="selectedVolume === 'lt100k'"
                >
                <span class="dot" />
              ...
              <label
                class="form-radio"
                :class="{ selected: selectedVolume === '100k-1m' }"
                @click="selectRadio('100k-1m')"
              >
                <input
                  type="radio"
                  name="volume"
                  value="100k-1m"
                  :checked="selectedVolume === '100k-1m'"
                >
                <span class="dot" />
                <span>100k – 1M</span>
              </label>
              <label
                class="form-radio"
                :class="{ selected: selectedVolume === '1m-10m' }"
                @click="selectRadio('1m-10m')"
              >
                <input
                  type="radio"
                  name="volume"
                  value="1m-10m"
                  :checked="selectedVolume === '1m-10m'"
                >
                <span class="dot" />
                <span>1M – 10M</span>
              </label>
              <label
                class="form-radio"
                :class="{ selected: selectedVolume === 'gt10m' }"
                @click="selectRadio('gt10m')"
              >
                <input
                  type="radio"
                  name="volume"
                  value="gt10m"
                  :checked="selectedVolume === 'gt10m'"
                >
                <span class="dot" />
                <span>Over 10M</span>
              </label>
          ...
          <div class="form-field">
            ...
            <textarea
              ...
              name="notes"
              rows="3"
              placeholder="e.g. &quot;I want to mirror a trader's spot signals without giving anyone withdrawal access to my funds&quot; or &quot;I run a signal channel and need every follower's Layer tracked and reconciled correctly&quot;"
            />
          </div>
          ...
          <button
            ...
            class="cta__submit"
          >
            Send walkthrough + request access
          </button>
        </form>

        <aside class="cta__aside">
          <div class="cta__aside-block">
            <div class="cta__aside-label">
              What you receive
            </div>
