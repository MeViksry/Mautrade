...
<template>
  <section class="thesis">
    <div class="container reveal">
      <div class="eyebrow">
        Why we built this — 002
      </div>
      <div class="section-head">
        <h2 class="section-head__title">
          Copy trading breaks<br>at the <em>decimal point</em>.
        </h2>
        <p class="section-head__sub">
          We rebuilt copy trading from the ledger up, because every tool we tried made the same three mistakes: it rounded money to fit a float, it averaged your positions instead of isolating them, and it broke the moment your account changed. Mautrade fixes all three by design, not by patch.
        </p>
      </div>

      <div class="thesis__grid">
        <div class="thesis__col">
          <div class="thesis__col-num">
            01 / Accuracy
          </div>
